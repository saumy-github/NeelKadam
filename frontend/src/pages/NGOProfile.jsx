...
export default function NGOProfile() {
  ...
  const ngoDetails = {
    name: "Mangrove Foundation",
    licenseNo: "LIC123456",
    email: "ngo@example.com",
    phone: "+91-9876543210",
    spokesperson: "Ravi Kumar",
    pan: "ABCDE1234F",
    bank: {
      accountHolder: "Mangrove Foundation",
      ...
      <main className="flex-grow p-8 space-y-8">
        ...
        <section className="bg-white p-6 rounded-xl shadow mb-6">
          ...
          <ul className="space-y-2 text-gray-700">
            <li><strong>Name:</strong> {ngoDetails.name}</li>
            <li><strong>License No:</strong> {ngoDetails.licenseNo}</li>
            <li><strong>Email:</strong> {ngoDetails.email}</li>
            <li><strong>Phone:</strong> {ngoDetails.phone}</li>
            <li><strong>Spokesperson:</strong> {ngoDetails.spokesperson}</li>
            <li><strong>PAN No:</strong> {ngoDetails.pan}</li>
            <li>
              <strong>Bank Details:</strong><br />
              {ngoDetails.bank.accountHolder}, A/C: {ngoDetails.bank.accountNumber},<br />
              IFSC: {ngoDetails.bank.ifsc}, MICR: {ngoDetails.bank.micr}
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white p-6 rounded-xl shadow mb-6">
          ...
          <p className="text-gray-700"><strong>Total Credits Earned:</strong> {wallet.totalCredits} CC</p>
        </section>

...
export default function BuyerForgotPassword() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50">
      <main className="flex-grow flex justify-center items-start pt-20 px-6 sm:px-12">
        <form
          onSubmit={handleResetPassword}
          className="bg-white shadow-2xl rounded-3xl p-12 w-full max-w-md border border-gray-300"
        >

        ...
        >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full p-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400 text-lg bg-gradient-to-r from-purple-50 to-white transition"
              required
              disabled={loading}
            />
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full p-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400 text-lg bg-gradient-to-r from-blue-50 to-white transition"
              required
              disabled={loading}
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-xl font-semibold text-lg bg-gradient-to-r from-purple-500 via-purple-600 to-purple-400 text-white hover:bg-purple-800 shadow-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {loading ? (
